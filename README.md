...
A Mod Pack designed around our network, This pack is available on fabric *and on forge*(REMOVED, legacy versions only), the pack adds many mods that will only change things client side that are non cheaty, and server friendly which should mean you can use it on your favourite servers such as hypixel.
...
## Mods Included
| Mod                   | Mod Version     | In Dev | In Release | In LTE | Link                                                                      | 
| :-------------------- | :-------------: | :----: | :--------: | :--------: | :-----------------------------------------------------------------------: |
...
| DarkLoadingScreen     |  1.6.3          |   ❌   |     ✔️    | | https://www.curseforge.com/minecraft/mc-mods/dark-loading-screen          |
...
**MultiMC/GDLauncher:**  Soon (Dev Versions are available from Discord donators have pre release dev version access which are released every 4 days if available)
